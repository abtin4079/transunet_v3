...
parser.add_argument('--saliency-model', type=str, default='fine_grained', choices=['fine_grained', 'spectral_residual'], help='saliency model (fine_grained / spectral_residual)')
